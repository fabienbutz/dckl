...
test_criteria:
  ...
  - id: api-crud
    ...
    checked: true
  - id: cli-create
    label: 'CLI: dckl journey new <slug> scaffolds .dckl/journeys/<slug>.md'
    checked: true
corrections:
  - id: c1
    text: >-
...
depends_on: []
pre_flight:
  - Re-read the Journeys section in .claude/skills/dckl/SKILL.md
  - Confirm the repo has zero existing .dckl/journeys/ files before coding
updated: '2026-04-23T12:57:56.202Z'
---

## DCK-01: Journeys — schema, parser, CLI

Introduce the Journey concept as a first-class dckl entity. A Journey is
